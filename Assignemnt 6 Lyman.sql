...
insert into Stats (Playerstats_ID, Kills, Deaths, Total_CS, Elo_Rank, Win_Rate) values (16, 7, 23, 90, "Diamond", 32);
...
insert into Stats (Playerstats_ID, Kills, Deaths, Total_CS, Elo_Rank, Win_Rate) values (19, 2, 2, 90, "Gold", 86);
...
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(90, 16, 27, 6, 123456, 123456789);
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(15, 16, 76, 7, 123456, 123456789);
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(15, 16, 25, 8, 123456, 123456789);
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(95, 16, 5, 9, 123456, 123456789);
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(15, 16, 90, 10, 123456, 123456789);
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(15, 16, 25, 11, 123456, 123456789);
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(99, 16, 1, 12, 123456, 123456789);
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(15, 16, 20, 13, 123456, 123456789);
...
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(15, 16, 1, 16, 123456, 123456789);
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(15, 16, 25, 17, 123456, 123456789);
insert into Champ_Stats(WinRate, BanRate, PickRate, Champion_ID, Item_Num, Rune_Num) values(15, 16, 5, 18, 123456, 123456789);
...
insert into PlayerChampStats(Champ_Kills, Champ_Deaths, Champ_CS, Champ_Gold, Champ_WinRate, PlayerID, Champion_ID) values (2, 56, 127, 100500, 50, 5, 5);
...
insert into PlayerChampStats(Champ_Kills, Champ_Deaths, Champ_CS, Champ_Gold, Champ_WinRate, PlayerID, Champion_ID) values (2, 56, 127, 100000, 65, 8, 8);
...
insert into PlayerChampStats(Champ_Kills, Champ_Deaths, Champ_CS, Champ_Gold, Champ_WinRate, PlayerID, Champion_ID) values (2, 56, 127, 100100, 89, 11, 11);
...
insert into PlayerChampStats(Champ_Kills, Champ_Deaths, Champ_CS, Champ_Gold, Champ_WinRate, PlayerID, Champion_ID) values (2, 56, 127, 100000, 90, 14, 14);
...
SELECT * FROM item;
SELECT * FROM rune;
SELECT * FROM Champ_stats;
SELECT * FROM PlayerChampStats; */

SELECT MAX(Win_Rate) AS BestWinRate
FROM Stats;

SELECT MIN(Win_Rate) as WorseWinRate
FROM Stats;

SELECT * From Champions
where Champ_Region = "The Void";

SELECT * From Stats
where Elo_Rank = "Gold" OR Elo_Rank = "Diamond";

SELECT * From Stats
where Elo_Rank = "Bronze";

SELECT * From Stats
ORDER BY Win_Rate DESC;

SELECT * From Player
where Main_Pos = "Jungle" and Sec_Pos = "Support";

SELECT * From Champions
where Champ_Name = "Ahri";

SELECT * From Item
where item_Num = 123456;

SELECT * From Rune
where rune_Num = 123456789;

SELECT MAX(BanRate) AS MostBan
FROM Champ_Stats;
...
SELECT * From Champ_Stats
ORDER BY PickRate ASC;

SELECT * From Champions
where Champion_ID = 8;

SELECT * From PlayerChampStats
where Champ_WinRate > 50 and Champ_CS > 75;

SELECT * From Stats
ORDER BY TOTAL_CS ASC;

SELECT * From Champ_Stats
where WinRate > 90 and PickRate < 10;

SELECT * From PlayerChampStats
where Champ_Gold > 10000 and Champ_Kills > 10;

SELECT * From Stats 
where Deaths > 25 and Total_CS < 100;

SELECT * From Champ_Stats
where PickRate = 15 and Rune_Num = 123456789;


SELECT S.Playerstats_ID, S.Kills, S.Deaths, S.Total_CS, S.Elo_Rank, S.Win_Rate, P.Main_Pos, P.Sec_Pos
FROM Stats as S
JOIN Player as P 
ON P.Playerstats_ID = S.Playerstats_ID;
